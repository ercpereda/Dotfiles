# Generated by Powerlevel10k configuration wizard on 2021-05-01 at 21:13 EDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 32822.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, blurred heads, slanted tails, 2 lines, dotted, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k|kubectl|helm|flux|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern|cluster|alayaflux'
